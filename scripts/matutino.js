...
window.onload = function () {
  ...
  function adicionar() {
    const endPoint = rota.base + rota.m.geral;
  ...
  formPesquisa.addEventListener('submit', function (event) {
    ...
    let endPoint = rota.base + rota.m.doFiltro + "/" + pesquisa.value;
    let tr;
  ...
  function excluirLinha(event) {
    ...
    const endPoint = rota.base + rota.m.geral + "/" + id;
  ...
  function alterar() {
    // const endPoint = rota.base + rota.m.geral + "/" + dados.id;
    const endPoint = rota.base + rota.m.geral + "/" + id.value;
    // Pegar os dados do formulário
    const dados = {
      id: id.value,
